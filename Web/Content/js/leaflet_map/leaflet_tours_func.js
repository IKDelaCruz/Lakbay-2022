$('#collapseMap').on('shown.bs.collapse', function(e) {
    ...
    var myIcon = L.icon({
        iconUrl: '/Content/img/pins/Marker.png',
        iconRetinaUrl: '/Content/img/pins/Marker.png',
        iconSize: [30, 42],
        iconAnchor: [9, 21],
        popupAnchor: [6, -15]
    });
    ...
    for (var i = 0; i < markers.length; ++i) {
        var popup =
            ...
            '<a href="tel://' + markers[i].phone + '" target="_blank" class="btn_infobox_phone">' + markers[i].phone + '</a>' +
            '</span>';
