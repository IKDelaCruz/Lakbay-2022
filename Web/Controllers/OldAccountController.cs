...
{
    [Authorize]
    public class OldAccountController : BaseController
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    TempData["LinkId"] = model.Username;
                    TempData["LinkType"] = model.Type;
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                AddErrors(result);
                model.Message = result.Errors.First().ToString();
            }
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                TempData["LinkId"] = info.Login.ProviderKey;
                TempData["LinkType"] = info.Login.LoginProvider;
